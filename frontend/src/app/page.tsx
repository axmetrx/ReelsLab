    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <p className="mt-2 text-xs sm:text-sm text-slate-600">
          {mode === 'register'
            ? 'Создайте аккаунт ученика в системе ReelsLab'
            : 'Введите ваши данные для входа в обучающий кабинет'}
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-6 shadow-sm border border-slate-200 rounded-2xl sm:px-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-4 rounded-xl text-sm transition-all shadow-md shadow-blue-600/10 flex items-center justify-center gap-2 active:scale-[0.99] mt-2 cursor-pointer"
            >
              <span>
                {loading
                  ? 'Обработка...'
